    ...
    <SafeAreaView className="flex-1 bg-gray-50">
      <ScrollView className="flex-1">
        ...
        <View className="bg-[#009245] px-6 pt-6 pb-8 rounded-b-3xl">
          ...
          <Text className="text-white/80 text-sm">Make loan repayments</Text>
        </View>
          ...
          {!user?.isApproved ? (
            <View className="bg-yellow-50 border border-yellow-200 rounded-2xl p-6 items-center">
              ...
              <Text className="text-yellow-800 text-sm text-center">
                Payment features will be available once your account is approved.
              </Text>
            </View>
          ) : (
            <View className="bg-white rounded-2xl p-6 items-center">
              ...
              <Text className="text-gray-600 text-center">
                Payment features will be implemented in the next phase.
              </Text>
            </View>
          )}
        </View>
